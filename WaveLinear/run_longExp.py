...
parser.add_argument('--model', type=str,  default='DLinear',
                    help='model name, options: [WLinear4, Informer, Transformer]')
...
#parser.add_argument('--dishts', action='store_true',default=False, help='whether to apply DishTS')
...
parser.add_argument('--dec_lev', type=int, default=15, help='wavelet decomposition layer number')
